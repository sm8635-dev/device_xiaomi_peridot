...
void vendor_load_properties() {
    ...
    if (region == "IN") {
        device = "peridot";
        brand = "POCO";
        description = "peridot_global-user 16 BP2A.250605.031.A3 OS3.0.301.0.WNPMIXM release-keys";
        fingerprint = "POCO/peridot_global/peridot:16/BP2A.250605.031.A3/OS3.0.301.0.WNPMIXM:user/release-keys";
        marketname = "POCO F6";
        model = "24069PC21I";
    } else if (region == "GL") {
        device = "peridot";
        ...
        device = "peridot";
        brand = "Redmi";
        description = "peridot-user 15 AQ3A.240912.001 OS2.0.101.0.VNPCNXM release-keys";
        fingerprint = "Redmi/peridot/peridot:15/AQ3A.240912.001/OS2.0.101.0.VNPCNXM:user/release-keys";
